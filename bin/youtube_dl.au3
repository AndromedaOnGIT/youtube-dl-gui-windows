#cs ----------------------------------------------------------------------------
	...
	Script Function:
	A surprisingly robust youtube downloader(copied the base code from another project of mine hence the bad naming of things)
...
Func spmGui()
	...
	$form1_1_1 = GUICreate("Youtube_DL GUI", 260, 250, 900, 400, BitOr($WS_BORDER, $WS_POPUP), BitOR($WS_EX_TOPMOST, $WS_EX_TOOLWINDOW))
	$input1 = GUICtrlCreateInput("", 100, 80, 150, 21)
    $input2 = GUICtrlCreateInput("", 100, 50, 150, 21)
	$label1 = GUICtrlCreateLabel("Video URL", 10, 80, 80, 17)
	$label1 = GUICtrlCreateLabel("Flags", 10, 50, 80, 17)
	$button1 = GUICtrlCreateButton("GO", 150, 120, 100, 30)
		    GUICtrlSetBKColor(-1,0x4250f4)
     		GUICtrlSetColor(-1,0xFFFFFF)
	$button55 = GUICtrlCreateButton("List Flags", 10, 120, 100, 30)
		    GUICtrlSetBKColor(-1,0x4250f4)
     	GUICtrlSetColor(-1,0xFFFFFF)
